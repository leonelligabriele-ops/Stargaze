 ...
 */
export default function HalfStars({ value = 0, onChange, size = '1.9rem', clearable = false, readOnly = false }) {
  const [hover, setHover] = useState(0)
  const active = (readOnly ? 0 : hover) || value || 0
  ...
  return (
    <div className="hstars" style={{ fontSize: size }} onMouseLeave={() => !readOnly && setHover(0)}>
      {[1, 2, 3, 4, 5].map(n => {
